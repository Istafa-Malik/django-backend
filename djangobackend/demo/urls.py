...
from .views import login, list_files, list_folders, download_folder,edit, delete, create, upload_folder, logout, create_fold, get_users, get_folders
...
urlpatterns = [
    ...
    path('get-users/',get_users, name='getUsers'),
    path('get-folders/', get_folders, name='getFolders')
]
